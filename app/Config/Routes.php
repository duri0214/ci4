...
$routes->get('school/admin/user/list', 'SchoolUserController::userList', ['as' => 'user_list']);
$routes->get('school/admin/user/(:num)/detail', 'SchoolUserController::userDetail/$1', ['as' => 'user_detail']);
$routes->get('school/admin/user/create', 'SchoolUserController::userCreate', ['as' => 'user_create']);
